#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu Sep  6 15:25:56 BST 2018      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -n 20 --mpi=pmi2 --mem-per-cpu=500 nice -n 10 /mnt/zfsusers//mcmaster/ramses/bin/ramses3d params.nml
